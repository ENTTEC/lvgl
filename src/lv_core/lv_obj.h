...
enum {
    ...
    LV_EVENT_SHORT_CLICKED, /**< User pressed object for a short period of time, then released it. Not called if
                               dragged. */
    LV_EVENT_LONG_PRESSED, /**< Object has been pressed for at least `LV_INDEV_LONG_PRESS_TIME`.  Not called if
                              dragged.*/
...
enum {
    ...
    LV_SIGNAL_LONG_PRESS, /**< Object has been pressed for at least `LV_INDEV_LONG_PRESS_TIME`.  Not called if
                             dragged.*/
    LV_SIGNAL_LONG_PRESS_REP, /**< Called after `LV_INDEV_LONG_PRESS_TIME` in every `LV_INDEV_LONG_PRESS_REP_TIME` ms.
...
#define LV_DEBUG_IS_OBJ(obj_p, obj_type)                                                                               \
    (lv_debug_check_null(obj_p) && lv_debug_check_obj_valid(obj_p) && lv_debug_check_obj_type(obj_p, obj_type))
#endif
